...
export const OutlinedButton = ({ children, onClick }: CustomButtonProps ) => {
  ...
  return (
    <MuiButton
      ...
      disabled={disabled}
      onClick={onClick}
      sx={{ textTransform: "uppercase", fontWeight: 500, borderRadius: "12px", backgroundColor: 'white', minHeight: '40px',
        width: 'fit-content' }}
    >
      {children}
    </MuiButton>
